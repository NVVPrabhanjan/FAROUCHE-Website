...
export default function EventRegistration() {
  ...
  const generateConfettiParticles = () => {
    ...
    const colors = ['#8B5CF6', '#EC4899', '#6366F1', '#10B981', '#F59E0B', '#F3F4F6']
            ...
            >
              ...
              >
                ...
                <div className="text-center space-y-4">
                  ...
                  >
                    Thank you for registering! A confirmation email has been sent with all the details.
                  </motion.p>
              ...
              {confettiParticles.map((particle) => (
                <motion.div
                  ...
                  style={{
                    ...
                    borderRadius: Math.random() > 0.7 ? '50%' : Math.random() > 0.5 ? '2px' : '0%',
                    left: `${particle.x}%`,
                  }}
                  initial={{ 
                    y: particle.y, 
              ...
              {[...Array(5)].map((_, i) => (
                <motion.div
                  ...
                  style={{
                    ...
                    border: `1px solid ${['rgba(139,92,246,0.3)', 'rgba(236,72,153,0.3)', 'rgba(99,102,241,0.3)'][Math.floor(Math.random() * 3)]}`,
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="pt-6">
              <motion.button
                ...
                type="submit"
                disabled={isLoading}
                className={`w-full py-4 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold text-lg transition-all shadow-md shadow-purple-900/30 relative overflow-hidden ${isLoading ? 'cursor-not-allowed opacity-80' : 'hover:from-purple-700 hover:to-pink-700'}`}
              >
                {isLoading ? (
