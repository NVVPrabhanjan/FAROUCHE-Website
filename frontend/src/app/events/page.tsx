                    ...
                    sortedEvents.map((event, index) => (
                        ...
                        >
                            <Link href={`/events/${event.eventid}/${event.teamSize}`} className="block group">
                                <article className="relative border border-white/10 p-8 md:p-12 transition-all duration-500 hover:border-zinc-500/50 hover:bg-white/[0.02] flex flex-col md:flex-row gap-8 justify-between items-start md:items-center overflow-hidden">
                                    ...
                                    <div className="flex-1 z-10">
                                        ...
                                        <h2 className="text-4xl md:text-5xl font-bold uppercase tracking-tight mb-2 group-hover:text-zinc-400 transition-colors duration-300">
                                            {event.title}
                                        </h2>
                                    ...
                                    <div className="z-10 bg-white/5 p-4 rounded-full border border-white/10 group-hover:bg-zinc-500 group-hover:text-black group-hover:border-zinc-500 transition-all duration-300">
