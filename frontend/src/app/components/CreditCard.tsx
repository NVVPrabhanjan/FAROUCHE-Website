...
const CreditCard = ({ person }) => {
  ...
  const getSocialIcon = (type: any) => {
    switch (type) {
      ...
      case "github":
        return (
          <Github size={16} className="hover:scale-110 transition-transform" />
        );
      case "website":
      default:
        return (
          <Link size={16} className="hover:scale-110 transition-transform" />
        );
    }
  };
    ...
    <div className="flex flex-col bg-purple-900 rounded-lg shadow-lg overflow-hidden w-full max-w-xs transform hover:-translate-y-1 transition-transform duration-300">
      ...
      <div className="p-4 w-full bg-black">
        ...
        <div className="flex justify-center space-x-4 mt-3">
          {person.socials.map((social: { url: string | undefined; type: any; }, index: React.Key | null | undefined) => (
            <a
              key={index}
              href={social.url}
  ...
  const people = [
    {
      ...
      socials: [
        ...
        {
          type: "instagram",
          url: "https://www.instagram.com/venkataprabhanjan?igsh=MTliMDAzeXE5bTc1dw==",
        },
        {
          type: "linkedin",
          url: "https://www.linkedin.com/in/n-v-venkata-prabhanjan-740213248/",
        },
    ...
    },
    {
      ...
      socials: [
        ...
        {
          type: "linkedin",
          url: "https://www.linkedin.com/in/vinay-yele-08ab08295/",
        },
    ...
    },
    {
      ...
      socials: [
        ...
        {
          type: "linkedin",
          url: "https://www.linkedin.com/in/puli-darshan-reddy-086a8530b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
        },
        {
          type: "github",
          url: "https://github.com/DarshanPuli?tab=repositories",
        },
      ],
    },
  ];
