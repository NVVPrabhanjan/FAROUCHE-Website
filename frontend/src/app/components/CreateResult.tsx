  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <DialogFooter>
        <button
          type="submit"
          className="inline-flex items-center justify-center py-2.5 px-5 rounded-md bg-zinc-600 text-white hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-zinc-500"
        >
          Submit Result
        </button>
      </DialogFooter>
