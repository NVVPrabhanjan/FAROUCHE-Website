...
const CommitteeCard = ({
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-zinc-600 to-zinc-500 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500" />


            <div className="flex justify-between items-start">
                <span className="text-xs font-mono text-neutral-500 group-hover:text-zinc-400 transition-colors">
                    ...
                    {committee.images.map((image, idx) => (
                        ...
                        >
                            ...
                            <div className="space-y-1">
                                <p className="text-lg font-medium leading-none text-center">{image.caption}</p>
                                {image.role && (
